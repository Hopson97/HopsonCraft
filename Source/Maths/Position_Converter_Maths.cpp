...
namespace Maths
{
    ...
    {
        int x = (int) worldPosition.x % World_Constants::CHUNK_SIZE;
        int z = (int) worldPosition.z % World_Constants::CHUNK_SIZE;
    ...
    {
        return  {(int)std::floor( worldPosition.x / World_Constants::CHUNK_SIZE),
                 (int)std::floor( worldPosition.z / World_Constants::CHUNK_SIZE)};
    }
    ...
    {
        int x = cLocation.x * World_Constants::CHUNK_SIZE;
        int z = cLocation.z * World_Constants::CHUNK_SIZE;
